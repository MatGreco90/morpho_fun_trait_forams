...
# Define a function to download and process mean pH projections for a given dataset
extract_ph_projections_points <- function(x) {
  ...
  variables = "ph_mean" # Variable to download: mean pH projections
...
saveRDS(points_combined_results,'data/points_biooracle_ph_mean.RDS')
